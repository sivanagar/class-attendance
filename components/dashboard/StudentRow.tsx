...
export default function StudentRow(student : StudentRowProps) {
    const [studentId, firstName, lastName] = [student.student.id, student.student.firstName, student.student.lastName];
                      ...
                      <TableCell className="text-right">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem onSelect={handleViewHistory}>View History</DropdownMenuItem>
                            <DropdownMenuItem className="text-red-600" onSelect={() => setOpen(true)}>Remove Student</DropdownMenuItem>
                          </DropdownMenuContent>
                        </DropdownMenu>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              student, <b>{firstName} {lastName}</b>, from the database.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
